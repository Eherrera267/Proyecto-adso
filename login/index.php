...
<head>
  ...
  <!-- Font Awesome -->
  <link rel="stylesheet" href="../public/template/AdminLTE-3.2.0/public/template/plugins/fontawesome-free/css/all.min.css">
  <!-- icheck bootstrap -->
...
<div class="login-box">
  <!-- /.login-logo -->
   <center>
   <img src="../public/images/shany_coffee.png" alt=""width="300px">
   </center>
